...
# CreateDate   : 2022-07-03 12:24:07
# LastEditors  : fujun 14149812@qq.com
# LastEditTime : 2022-07-03 12:45:39
# FilePath     : /MusicPlayer/tests/mtest.py
# Description  : 
# 
...
def getUin(pagnerNum):
    x = 0
    header = {
        'Referer': 'https://y.qq.com/portal/profile.html?uin=1152921504613031000#sub=song&tab=like&',
    ...
    # call的变化可能导致此处长度的变化，可以考虑此处用正则表达式再用split函数获取值=
