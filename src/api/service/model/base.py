...
def _deserialize(data, klass):
    ...
    if klass in six.integer_types or klass in (float, str, bool):
        ...
        return deserialize_data(data, klass)


def deserialize_data(data: dict | list, klass: typing.Type[T]):
    """
...
class BaseModel(object):
    ...
    @classmethod
    def from_dict(cls: typing.Type[T], dictionary) -> T:
        """Returns the dict as a model"""
        return deserialize_data(dictionary, cls)
